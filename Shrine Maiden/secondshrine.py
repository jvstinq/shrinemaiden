...
async def on_ready():
    ...
    embed = discord.Embed( #Rules
      title = "Welcome to the Guuji Gang", # add more to this line of code
      description = "Welcome to my server! This is a server for my close friends, friends, and followers of youtube, twitch, etc. I give tips for VALORANT and Genshin Impact mostly, not really anything else. If you need people to talk to , just talk to us. It would be so chill ngl", # add more on to this line of code
      color = 0xffb7c5
    )
    embed.add_field(
    ...
    embed = discord.Embed(
      title = "Roles in the Discord",
      description = "\nGang Leaders - Akito and Justin\n\nBesties - Besties of Justin \n\nShrine Staff - Moderators of the Server\n\nIRL's - People that Justin know and/or met IRL\n\nJustinnians - Special Friend Group\n\nGang Members(Friends) - Friends of Justin\n\nHONKAIERS - Special Role for all Honkai Starrail Players",
      color = 0xffb7c5
    )
    await welcomeChannel.send(embed = embed)
    """
...
@client.command
async def yaemiko(ctx):
  await ctx.send("I love Yae Miko!")
